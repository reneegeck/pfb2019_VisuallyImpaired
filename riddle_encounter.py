#!/usr/bin/env python
import user, time, colorama, subprocess  #Personality_quiz, weapon_choice, little_vinnys
...
#========================================================================
	...
	if response == 'yes':
		print(color.CYAN + "\nGreat! Let's get started. Let's see if you can answer the following riddle.\n" + color.END)
		subprocess.run(["say", "-v", "Samantha", "Great! Let's get started. Let's see if you can answer the following riddle."])
...
#========================================================================
	...
	elif answer5.lower() != 'needle':
		print(color.CYAN + "\nThat was supposed to be a freebie. If there was one you were supposed to get right, this was it. Bless your heart child. May the wizard have pity on you." + color.END)
		subprocess.run(["say", "-v", "Samantha", "That was supposed to be a freebie. If there was one you were supposed to get right, this was it. Bless your heart child. May the wizard have pity on you."])
		user.print_user_stats()
		print(color.BOLD + 'Number of correct answers:' + color.END, correct_answers)
		time.sleep(2)
...
#========================================================================
	...
	if correct_answers > 2:
		print(color.CYAN + "\nWow, you answered 3 out of 5 riddles correctly! What an incredible achievement. Maybe you can put this on your résumé. As a reward for your intellectual cunning, I award you with a rare candy. Don't ask me what it does, cedar found it under the couch." + color.END)
		subprocess.run(["say", "-v", "Samantha", "Wow, you answered 3 out of 5 riddles correctly! What an incredible achievement. Maybe you can put this on your résumé. As a reward for your intellectual cunning, I award you with a rare candy. Don't ask me what it does, cedar found it under the couch"])
