...
class User(object):
	...
	def print_health_bar(self, decimals = 1, length = 100, fill = '█'):
		...
		if self.health < 11:
			...
			bar_out = 'Your health is now {:>3} points     |{}| {}%'.format(self.health, bar, percent)
		else:
	...
	def print_speed_bar(self, decimals = 1, length = 100, fill = '█'):
		...
		bar = color_dict['green'] + fill * filledLength + color_dict['end'] + color_dict['dim'] + fill * (length - filledLength) + color_dict['end']
		bar_out = 'Your speed is now {:>3} points       |{}| {}%'.format(self.speed, bar, percent)
		print(bar_out)
	...
	def print_armor_bar(self, decimals = 1, length = 100, fill = '█'):
		...
		bar = color_dict['green'] + fill * filledLength + color_dict['end'] + color_dict['dim'] + fill * (length - filledLength) + color_dict['end']
		bar_out = 'Your armor is now {:>3} points       |{}| {}%'.format(self.armor, bar, percent)
		print(bar_out)
	...
	def print_intel_bar(self, decimals = 1, length = 100, fill = '█'):
		...
		bar = color_dict['green'] + fill * filledLength + color_dict['end'] + color_dict['dim'] + fill * (length - filledLength) + color_dict['end']
		bar_out = 'Your intelligence is now {:>3} points|{}| {}%'.format(self.intel, bar, percent)
		print(bar_out)
